        ...
        <div className="flex items-center gap-6">
          ...
          {isDesktop && (
            <nav className="flex items-center gap-6 text-md text-muted-foreground">
              <Link href="#home" className="hover:text-foreground transition-colors navlink">
                Accueil
              </Link>
              <Link href="#about" className="hover:text-foreground transition-colors navlink">
                À propos
              </Link>
              <Link href="#pricing" className="hover:text-foreground transition-colors navlink">
                Tarifs
              </Link>
              <Link href="/contact" className="hover:text-foreground transition-colors navlink">
                Contact
              </Link>
            </nav>
          )}
