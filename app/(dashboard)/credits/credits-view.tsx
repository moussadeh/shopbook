...
export default function CreditsView({
  ...
  const openEditCredit = (c: CreditRow) => { setDetailOpen(false); setSelected(c); setFormOpen(true); };
  const openNouveauCredit = () => { setDetailOpen(false); setSelected(null); setFormOpen(true); };
    ...
    <div className="min-h-screen bg-gray-50/60">
      <div className="px-4 md:px-6 py-5 space-y-5 max-w-7xl mx-auto">
        ...
        <div className="hidden md:block bg-white rounded-2xl border overflow-hidden">
          <CreditsTable clients={paginated} onDetail={openDetail} onPaiement={openPaiement} />
          {filtered.length === 0 && (
        ...
        <div className="md:hidden space-y-3">
          <CreditsCards clients={paginated} onDetail={openDetail} onPaiement={openPaiement} />
          {filtered.length === 0 && (
      ...
      <CreditDetailDialog
        ...
        onNouveauCredit={openNouveauCredit}
      />
