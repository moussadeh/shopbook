...
//               <button className="mt-1 w-full rounded-xl py-2 text-sm font-semibold text-white transition hover:opacity-90 bg-vert-foncee">
//                 Découvrir les plans
//               </button>
//             </Link>
//           </div>
...
//       {/* ── SIDEBAR DESKTOP ── */}
//       <aside className="hidden lg:flex flex-col justify-between w-64 min-h-screen border-r bg-white px-4 py-6 shrink-0">
