...
import { MoreVertical, TrendingDown, Pencil } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50/60">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-md modale">
          <DialogHeader>
            <DialogTitle>{selected ? "Modifier le crédit" : "Nouveau crédit"}</DialogTitle>
            <DialogDescription>
